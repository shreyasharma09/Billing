...
const ChooseCustomerModal = (props) => {
    const[data,setdata]=useState([]) //sare customer is state m honge
    const[search,setsearch]=useState("") //jo hm search krnge 
    const[searched,setsearched]=useState([]) //searched data jo matched hoga vo is state m hoga 
