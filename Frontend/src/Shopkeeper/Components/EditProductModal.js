...
const EditProductModal = (props) => {
    ...
    const updateproduct=async(e)=>{
        try {
            ...
            const response=await fetch("http://localhost:3010/api/updateproduct/"+props.id,{
                method:"put",
            ...
            if(response.status===202){await props.getallproducts(userinfo.Authorization);props.setToggle(false);props.setid(null);props.setobj({})}      //update hogya to getallproduct(page p show krana),popup ko bnd krna,id null krna or obj khali krna
